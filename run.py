...
class OurArguments(TrainingArguments):
    ...
    # quant
    w_train_bits: int = 16  # weight quantization bits
    a_train_bits: int = 16 # activation quantization bits
...
class Framework:
    ...
    def __init__(self, args, task, eval=False):
        self.args = args
        self.task = task
        if not eval:
    ...
    def load_model(self):
        ...
        self.args.num_attention_heads = model.config.num_attention_heads
        # Load tokenizer
    ...
    def one_step_pred(self, train_samples, eval_sample, verbose=False):
        ...
        encoded_candidates, option_lens = encode_prompt(
            ...
            max_length=2048,
            generation=self.task.generation, max_new_tokens=50
        )
